"""
update_graphics.py — 调整 Slide5Network 中 graphic overlay 的位置。

数据溯源说明：参见 update_slide5.py 头部的完整注释。
本脚本中引用的"幽灵员工""家族暗网""REMEMBER JULIANA"等叙事文本
均为研究者推断，不是 employee_nodes.csv 的数据字段直接映射。
"""
